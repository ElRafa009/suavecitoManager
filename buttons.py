...
def create_buttons(button_frame, root, mensaje, texto, pantalla_errores, frame_lexico, frame_sintactico, frame_semantico, frame_symtab, frame_pcode):
    ...
    button_run = Button(button_frame, image=img_run, command=lambda: run_command(root, mensaje, texto, frame_lexico, pantalla_errores, frame_sintactico, frame_semantico, frame_symtab, frame_pcode))
