...
def create_editor():
    ...
    # Pestaña para Codigo Intermedio
    frame_pcode = ttk.Frame(tab_control_analisis)
    tab_control_analisis.add(frame_pcode, text='Codigo Intermedio')
    ...
    create_buttons(button_frame, root, mensaje, texto, pantalla_errores, frame_lexico, frame_sintactico, frame_semantico, frame_symtab, frame_pcode)
